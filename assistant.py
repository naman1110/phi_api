...
def get_groq_assistant(
    ...
    return Assistant(
        ...
        instructions=[
                "When a user asks a question, you will be provided with information relevant to the question from our knowledge base.",
                "Use the provided documents to retrieve accurate and up-to-date information necessary to answer the user's question.",
                "Provide clear and informed responses based solely on the information available in the provided documents.",
                "If no relevant information is available in the prompt to answer the user's question, respond with 'I don't have the information needed to answer that question.'",
